...
|-----------|----------------|
| Webhook delivery | `server/webhooks.js` |
| Admin configuration | Settings → Webhooks tab (`src/pages/Settings.jsx`) |
| Settings API | `GET/PATCH /api/settings`, `POST /api/settings/test-webhook` |
| Booking triggers | `server/routes/entities.js` |
